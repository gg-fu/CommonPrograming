...
#define utils_warning(...)      log_warning("utils",__VA_ARGS__)
#define utils_info(...)         log_info("utils",__VA_ARGS__)
#define utils_err(...)          log_err("utils",__VA_ARGS__)
#define utils_debug(...)        log_debug("utils",__VA_ARGS__)
